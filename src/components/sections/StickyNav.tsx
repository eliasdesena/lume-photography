    ...
    >
      <div className="max-w-content mx-auto">
        <div className="pointer-events-auto flex items-center justify-between pl-5 pr-2.5 py-2.5 rounded-full bg-obsidian/80 backdrop-blur-2xl border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
          ...
          <a
            href="/checkout"
            className="inline-flex items-center gap-1.5 bg-gold hover:bg-gold/90 active:scale-95 text-obsidian font-body font-semibold text-[11px] uppercase tracking-[0.14em] px-4 py-2 rounded-full transition-all duration-200"
          >
            Enroll
