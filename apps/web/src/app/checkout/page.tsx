...
const MultiStepCheckout = dynamic(
  () => import("@/components/checkout/MultiStepCheckout"),
  {
    loading: () => (
      <div className="bg-surface rounded border border-hairline p-8">
        <div className="animate-pulse space-y-5">
          <div className="h-3 bg-surface-2 rounded w-1/3" />
          <div className="h-6 bg-surface-2 rounded w-2/3 mt-4" />
          <div className="h-11 bg-surface-2 rounded mt-6" />
